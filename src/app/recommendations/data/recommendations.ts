import andersonImage from './images/anderson.png'
import felipeImage from './images/felipe.png'
import ronanImage from './images/ronan.png'
import gabrielImage from './images/gabriel.png'
import viniImage from './images/vini.png'
...
export const recommendations: Recommendation[] = [
  {
    ...
    text: 'Vitor is an excellent front-end developer, always focused on programming best practices and mindful of the technologies used. He consistently delivered high-quality code while meeting deadlines. Beyond his technical skills, Vitor is an outstanding team player, capable of handling challenges and always willing to help.'
  },
  {
    ...
    text: `It is with great pleasure that I recommend Vitor, with whom I had the privilege of working for 10 months. During this time, I witnessed firsthand his remarkable productivity, originality, responsibility, boldness, and intelligence as a front-end developer.
...
`
  },
  {
    ...
    text: `I would like to highly recommend Vitor Lostada, not only because he helped me immensely when I was starting with ReactJS but also because of his exceptional knowledge of the concepts behind programming languages. Vitor doesn’t just write code that works; he creates clean, scalable solutions that are a joy to work with, always staying true to deadlines and maintaining excellent organization.
