      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 text-justify text-lg text-muted-foreground">
          <p>
            ...
            passionate with ui and build beautiful things with great animations
            😍, I start my journey as the most developers, I wanted to create
          ...
          <p>
            and when I&apos;m not doing something for my professional I like to
            spend a time with my girlfriend or playing a game, I really like
            play games, I play a lot of games, and I always try teaches
            everthing that I learn, I think with this I learn more because when
            I teach I try explain the best way I can
          </p>
          <p>
